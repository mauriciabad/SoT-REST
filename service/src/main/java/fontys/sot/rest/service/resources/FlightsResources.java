...
public class FlightsResources {
    ...
    public Response getFlightByQuery(
        ...
        if (departure_before != null) {
            if (!Flight.isValidDate(departure_before)) return new ResponseError(422, "Parameter 'departure_before' must be in this format: YYYY-MM-dd hh:mm").build();
        ...
        if (departure_after != null) {
            if (!Flight.isValidDate(departure_after)) return new ResponseError(422, "Parameter 'departure_after' must be in this format: YYYY-MM-dd hh:mm").build();
        ...
        if (arrival_before != null) {
            if (!Flight.isValidDate(arrival_before)) return new ResponseError(422, "Parameter 'arrival_before' must be in this format: YYYY-MM-dd hh:mm").build();
        ...
        if (arrival_after != null) {
            if (!Flight.isValidDate(arrival_after)) return new ResponseError(422, "Parameter 'arrival_after' must be in this format: YYYY-MM-dd hh:mm").build();
    ...
    public Response updateFlight(Flight flight, @PathParam("flight_number") int flight_number) {
        if (flights.exists(flight_number)){
            ...
            return new ResponseError(404, "Flight with flight_number " + flight_number + " doesn't exist").build();
        }
    }
